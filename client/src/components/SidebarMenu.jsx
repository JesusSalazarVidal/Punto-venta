...
function SidebarMenu() {
  return (
    <div>
      ...
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 z-40 w-64 h-screen pt-16 transition-transform -translate-x-full border-r  sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700 bg-emerald-300"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-emerald-300 border-2 border-pink-800 dark:bg-gray-800">
      ...
      <div className="p-10 sm:ml-64"></div>
    </div>
  );
}
