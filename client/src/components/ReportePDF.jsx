...
*/
  ...
  return (
    <div>
  <button class="bg-gradient-to-r from-emerald-400 to-pink-400 rounded-md font-bold text-gray-900 ml-5 px-4 py-2 hover:from-pink-400 hover:to-emerald-400" onClick={generarPDF}>Generar PDF</button>
</div>
